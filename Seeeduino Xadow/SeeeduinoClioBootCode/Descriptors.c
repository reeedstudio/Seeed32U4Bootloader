...
#define DEVICE_PID  0X0003          // seeeduino Xadow
...
const USB_Descriptor_String_t ProductString =
{
    ...
    #elif DEVICE_PID == 0x0001
	.UnicodeString          = L"Seeeduino Clio  "               // Seeeduino Clio
    #elif DEVICE_PID == 0x0002
    .UnicodeString          = L"Seeeduino Lite  "               // Seeeduino Lite
    #elif DEVICE_PID == 0X0003
    .UnicodeString          = L"Seeeduino Xadow "               // Seeeduino xadow
	#else
